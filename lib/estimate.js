...
/**
 * @typedef {Object} EstimatorParams
 * @property {string} estimator
 * @property {pointTyping.Point[]} domain
 * @property {pointTyping.Point[]} range
 * @property {pointTyping.Point} [center]
 * @property {number} [angle]
 */

/**
 * @param {EstimatorParams} params
...
module.exports = function (params) {
  ...
  switch (params.estimator.toUpperCase()) {
    ...
    default:
      throw new Error('Unknown estimator type: ' + params.estimator)
  }
}
